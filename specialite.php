<?php    
    ...
    $traitement = $connexion->prepare("SELECT * FROM service WHERE codes =$src");
        ...
        <div class="col-xs-12">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Si vous voulez ajouter une nouvelle specialite cliquer sur  ce bouton</h3>
            </div>
            <div class="box-body">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                  <form method="POST">
                  <input class="form-control" type="text" name="spt"  placeholder="specialite"><br><br>
                  <select class="form-control" name="src">
                    <option>Service</option>
                      <option  value="<?=$contenu['codes'] ;?>"><?=$contenu['libs'] ;?></option>
                  </select><br><br>
                  ...
                  <?php 
                          ...
                          //preparation de la requette sql
                            $insertion = $connexion->prepare('INSERT INTO specialite VALUES(NULL,:libser,:codes)');
                            //on lie chaque marqueur a une valeur
                            $insertion->bindvalue(':libser',$_POST['spt']);
                            $insertion->bindvalue(':codes',$_POST['src']);
                            ...
                            if ($resultat)
                                {
                                    echo "<script> 
                                            alert('la specialite est ajoutee avec succes')
                                        ;</script>
                                        ";
                                }
                                else
        ...
        <div class="col-xs-13">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste des specialites</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
